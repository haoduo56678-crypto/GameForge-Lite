...
const required = [
  'native-systems.js','native-systems-blueprint.js','native-systems-entry.js',
...
for (const tag of ['<script src="native-systems.js"></script>','<script src="native-systems-blueprint.js"></script>']) {
...
let blueprint = injectBefore(path.join(DIST, 'blueprint.html'), '<script src="blueprint-editor.js"></script>', [
...
if (!(blueprint.indexOf('native-forge-generator.js') < blueprint.indexOf('native-systems.js')
  && blueprint.indexOf('native-systems.js') < blueprint.indexOf('native-systems-blueprint.js')
...
let forge = injectBefore(forgePath, '<script src="native-forge-page.js"></script>', ['<script src="native-systems.js"></script>']);
forge = forge
...
const order = ['native-forge-generator.js','native-systems.js','native-systems-blueprint.js','js/app.js'];
...
for (const marker of [
  'BlockEntity','SimpleChannel','EntityType','Goal AI','native-systems-page.js'
]) {
